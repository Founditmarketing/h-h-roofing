...
module.exports = async (req, res) => {
  ...
  const service = pickField(body, "service");
...
—
Sent from the contact form on handhroofingllc.com`;
  const html = `
<h2>New lead from H&amp;H Roofing</h2>
...
<p style="color:#666;font-size:13px">Sent from the contact form on handhroofingllc.com</p>`;
